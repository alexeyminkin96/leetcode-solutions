 ...
 * - Runtime: `117 ms` (Beats `100.00%` of Kotlin submissions)
 * - Memory: `41.62 MB` (Beats `100.00%` of Kotlin submissions)
 *
 * **Complexity:**
 * - Time: `O(n²)`
 * - Space: `O(n)`
 *
 * **Notes:**
 * - [Full explanation](https://leetcode.com/problems/number-of-paths-with-max-score/solutions/8378066/kotlin-on2-127ms-on-by-alexeyminkin-7qka)
 */
